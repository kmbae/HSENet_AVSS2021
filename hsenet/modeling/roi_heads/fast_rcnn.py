...
class FastRCNNOutputs:
    ...
    def softmax_cross_entropy_loss(self):
        ...
        if self._no_instances:
            ...
            return F.cross_entropy(self.pred_class_logits, (self.gt_classes>0).long(), reduction="mean")
            #self._log_accuracy()
            if gt_source.sum():
                return F.cross_entropy(self.pred_class_logits[gt_source], self.gt_classes[gt_source], reduction="mean")
